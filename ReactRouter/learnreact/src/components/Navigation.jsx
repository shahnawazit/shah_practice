        ...
        <Link to="/contactus">Contact Us</Link> */}
            ...
            <aside id="sidebar" className="sidebar">
                <div className="brand">
                    ...
                    <div>
                        <h1>Admin Panel</h1>
                        <div className="muted" style={{ fontSize: '12px' }}>Dashboard</div>
                    </div>
                </div>

                <nav className="nav">
                    <Link to="/dashboard" data-section="overview"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 13h8V3H3v10zM3 21h8v-6H3v6zM13 21h8V11h-8v10zM13 3v6h8V3h-8z" /></svg><span className="label">Dashboard</span></Link>
                ...
                <div className="footer">
                    <div style={{ marginBottom: '8px' }}>Logged in as <strong>Admin</strong></div>
                    <div className="muted" style={{ fontSize: '12px' }}>simple-admin-panel v1.0</div>
                </div>
            </aside>
        </>
    )
