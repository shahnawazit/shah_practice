        ...
        <main className="main">
            <div className="topbar">
                <div className="flex gap-8">
                    <div className="search card" style={{ padding: '6px 10px', display: 'flex', alignItems: 'center' }}>
            ...
            <section className="grid">
                ...
                <div className="card col-12">
                    <h3>Activity</h3>
                    <div id="activity" style={{ marginTop: '12px', display: 'flex', gap: '12px', overflow: 'auto' }}>
                        <canvas id="miniChart" width="700" height="120" style={{ maxWidth: '100%' }}></canvas>
                    </div>
                </div>
            </section>
